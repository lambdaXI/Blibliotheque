        ...
        <div class="panel-body" ng-controller="auteurFormulaireController">
          ...
          <form class="form-horizontal" name="form" ng-submit="addAuteur()">
            ...
            <div class="form-group" id="formAge" ng-class="{'has-success': isInputValid(form.age),'has-error': isInputInvalid(form.age)}">
              ...
              <div class="col-sm-10">
                <input type="text" required pattern="^[0-9]{2}$" class="form-control" id="age" placeholder="age" name="age" ng-model="auteur.age">
            ...
            <div class="form-group" id="formNaissance" ng-class="{'has-success': isInputValid(form.date_naissance),'has-error': isInputInvalid(form.date_naissance)}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control date" id="date_naissance" required pattern="^[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" placeholder="dd/mm/aaaa" name="date_naissance" ng-model="auteur.date_naissance">
            ...
            <div class="form-group" id="formMort" ng-class="{'has-success': isInputValid(form.date_mort),'has-error': isInputInvalid(form.date_mort)}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control date" id="date_mort" required pattern="^[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" placeholder="dd/mm/aaaa" name="date_mort" ng-model="auteur.date_mort">

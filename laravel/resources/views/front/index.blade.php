        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <button type="button" name="button" class="btn btn-success" ng-click="ajouterpanier(livreDetail.id)">+</button> <button type="button" name="button" class="btn btn-danger" ng-click="supprimerpanier(livreDetail.id)">-</button>
            </div>
        ...
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <a class="btn btn-primary" role="button" ng-click="voir(livre)">voir (incremente la vue)</a><br>
             <button type="button" name="button" class="btn btn-success" ng-click="ajouterpanier(livre.id)">+</button> <button type="button" name="button" class="btn btn-danger" ng-click="supprimerpanier(livre.id)">-</button>
          </div>
        </div>
      </div>
    </div>
